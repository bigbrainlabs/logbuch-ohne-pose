...
Ich habe gerade meinen ersten Code geschrieben.
...
Ich habe gerade eine LED programmiert.
...
Ich bin ein Programmierer jetzt.
...
"Und das ist für's Boot?"

"Ja. Training."

"Du trainierst... LED blinken?"
...
Video sagt: Geht auch.

Wird dann 3.5V.

ESP32 verträgt bis 3.6V.
...
void loop() {
  ...
  float spannung = wert * (3.3 / 4095.0);
  float batterie = spannung * 4.0; // Rückrechnung
...
Von einem 8€ Computer.

Der ich programmiert habe.
...
Sie schaut auf den Tisch.

Breadboard.

Kabel-Chaos.

Display leuchtet: "12.3 V"
...
```
Projekt-Ideen:
✅ Voltmeter (funktioniert!)
☐ Tankanzeige (Ultraschall)
☐ Temperaturen (DS18B20)
☐ WiFi Dashboard
☐ Daten-Logging
☐ Alarme bei niedrigem Akku
☐ ...
```
